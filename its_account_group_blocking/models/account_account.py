...
class AccountAccount(models.Model):
    ...
    account_analytic_ids = fields.Many2many('account.analytic.account', 'account_analytic_ids_rel', 'account_id', 'analytic_id', store=True, string='Analytic accounts', help='Analytic accounts')
